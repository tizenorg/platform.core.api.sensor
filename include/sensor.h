...
typedef enum
{
	...
	SENSOR_HUMAN_SLEEP_MONITOR,             /**< Sleep monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_EXERCISE = 0x400,                /**< Exercise (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_WEAR_STATUS = 0x1A00,            /**< Wear status (Since 3.0) */
	SENSOR_WEAR_ON_MONITOR,                 /**< Wear on monitor (Since 3.0) */

	SENSOR_GESTURE_MOVEMENT = 0x1200,       /**< Movement (Since 3.0) */
	//SENSOR_GESTURE_WRIST_UP,                /**< Wrist up (Since 3.0) */

	SENSOR_NO_MOVE_DETECTOR = 0x1A80,       /**< No move detector (Since 3.0) */
	SENSOR_STRESS_MONITOR = 0x1A87,         /**< Stress monitor (Since 3.0) */
	SENSOR_STAIR_TRACKER = 0x1A89,          /**< Stair tracker (Since 3.0) */
	SENSOR_STEP_DETECTOR,                   /**< Step dectector (Since 3.0) */
