 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
int sensor_recorder_start(sensor_record_type_e type, sensor_recorder_option_e option);
...
int sensor_recorder_destroy_filter(sensor_recrod_filter_h filter);

int sensor_recorder_filter_set_int(sensor_record_filter_h filter, sensor_recorder_filter_e filter_type, int value);
int sensor_recorder_filter_unset_int(sensor_record_filter_h filter, sensor_recorder_filter_e filter_type);
...
int sensor_recorder_read(sensor_type_t type, sensor_record_filter_h filter, sensor_recorder_cb cb, void *user);
