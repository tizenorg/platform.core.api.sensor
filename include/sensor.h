...
typedef enum
{
	...
	SENSOR_HUMAN_STRESS_MONITOR,            /**< Stress monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_WALKING = 0x400,  /**< Exercise walking monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_RUNNING,          /**< Exercise running monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_HIKING,           /**< Exercise hiking monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_CYCLING,          /**< Exercise cycling monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_STAIR_CLIMBING,   /**< Exercise stair climing monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_ELLIPTICAL,       /**< Exercise elliptical monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_INDOOR_CYCLING,   /**< Exercise indoor cycling monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_STEPPER,          /**< Exercise stepper monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_HUMAN_EXERCISE_ROWING,           /**< Exercise rowing monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
