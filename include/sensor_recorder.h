...
typedef enum
{
	SENSOR_RECORDER_DATA_STEPS = 0x00,           /**< Count of both walking and running steps; Integer */
	SENSOR_RECORDER_DATA_WALK_STEPS,             /**< Count of walking steps; Integer */
	SENSOR_RECORDER_DATA_RUN_STEPS,              /**< Count of running steps; Integer */
	SENSOR_RECORDER_DATA_DISTANCE,               /**< Distance walked or ran (m); Double */
	SENSOR_RECORDER_DATA_CALORIE,                /**< Calorie burned (kcal); Double */
	SENSOR_RECORDER_DATA_HEART_RATE = 0x10,      /**< Heart Rate (BPM); Integer */
	SENSOR_RECORDER_DATA_SLEEP_STATE = 0x20,     /**< Sleep state; Integer; One of #sensor_sleep_state_e */
