...
typedef enum
{
	...
	SENSOR_RECORDER_SLEEP_STATE = SENSOR_HUMAN_SLEEP_MONITOR,	/**< It tracks the user's sleep states */
	SENSOR_RECORDER_EXERCISE = SENSOR_HUMAN_EXERCISE_MONITOR,	/**< It tracks the user's physical exercise */
