...
typedef enum
{
	...
	SENSOR_RECORDER_PEDOMETER = SENSOR_HUMAN_PEDOMETER,	/**< It tracks the user's walking and running
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_SLEEP_MONITOR = SENSOR_HUMAN_SLEEP_MONITOR,	/**< It tracks the user's sleep states
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_WALKING = SENSOR_HUMAN_EXERCISE_WALKING,  /**< Exercise walking monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_RUNNING,          /**< Exercise running monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_HIKING,           /**< Exercise hiking monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_CYCLING,          /**< Exercise cycling monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_STAIR_CLIMBING,   /**< Exercise stair climing monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_ELLIPTICAL,       /**< Exercise elliptical monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_INDOOR_CYCLING,   /**< Exercise indoor cycling monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_STEPPER,          /**< Exercise stepper monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
	SENSOR_RECORDER_EXERCISE_ROWING,           /**< Exercise rowing monitor (Since 3.0)
	                                             @n Privilege : http://tizen.org/privilege/healthinfo */
...
typedef enum
{
	SENSOR_RECORDER_EXERCISE_STATE, /* TBD */
 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
int sensor_recorder_read_sync(sensor_recorder_type_e type, sensor_recorder_query_h query, sensor_recorder_cb cb, void *user_data);
