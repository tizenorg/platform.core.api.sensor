...
typedef enum
{
	SENSOR_RECORDER_STEPS = 0x00,           /**< Count of both walking and running steps; Integer */
	SENSOR_RECORDER_WALK_STEPS,             /**< Count of walking steps; Integer */
	SENSOR_RECORDER_RUN_STEPS,              /**< Count of running steps; Integer */
	SENSOR_RECORDER_DISTANCE,               /**< Distance walked or ran (m); Double */
	SENSOR_RECORDER_CALORIE,                /**< Calorie burned (kcal); Double */
	SENSOR_RECORDER_HEART_RATE = 0x10,      /**< Heart Rate (BPM); Integer */
	SENSOR_RECORDER_SLEEP_STATE = 0x20,     /**< Sleep state; Integer; One of #sensor_sleep_state_e */
 ...
 */
int sensor_recorder_start(sensor_type_e type, sensor_recorder_option_e option);
 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
typedef void (*sensor_recorder_cb)(sensor_type_e type, sensor_recorder_data_h data, sensor_error_e error, void *user_data);
 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
int sensor_recorder_read(sensor_type_e type, sensor_recorder_query_h query, sensor_recorder_cb cb, void *user_data);
 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
int sensor_recorder_read_sync(sensor_type_e type, sensor_recorder_query_h query, sensor_recorder_cb cb, void *user_data);
 ...
 * @retval  #SENSOR_ERROR_OPERATION_FAILED     Operation failed
 */
int sensor_recorder_data_get_timestamp(sensor_recorder_data_h data, time_t *start_time, time_t *end_time);
